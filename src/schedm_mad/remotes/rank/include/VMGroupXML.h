...
public:
     ...
     */
    void set_antiaffinity_requirements(std::shared_ptr<VirtualMachinePoolXML>  vmpool,
     ...
     *    @params oss stream to output debug information
     */
    void set_affinity_requirements(std::shared_ptr<VirtualMachinePoolXML> vmpool,
     ...
     *    @params oss stream to output debug information
     */
    void set_host_requirements(std::shared_ptr<VirtualMachinePoolXML>  vmp,
                               std::ostringstream& oss);
