/* -------------------------------------------------------------------------- */
/* Copyright 2002-2026, OpenNebula Project Leads (OpenNebula.org)             */
/*                                                                            */
...
void VMGroupXML::set_antiaffinity_requirements(std::shared_ptr<VirtualMachinePoolXML> vmpool,
...
void VMGroupXML::set_host_requirements(std::shared_ptr<VirtualMachinePoolXML> vmpool,
                                       std::ostringstream& oss)
{
    oss << "\n";
    oss << setfill('-') << setw(80) << '-' << setfill(' ') << "\n";
...
static void schecule_affined_set(const std::set<int>& vms,
                                 std::shared_ptr<VirtualMachinePoolXML> vmpool, std::shared_ptr<VirtualMachineRolePoolXML> vm_roles_pool,
                                 std::ostringstream& oss)
{
...
void VMGroupXML::set_affinity_requirements(std::shared_ptr<VirtualMachinePoolXML> vmpool,
                                           std::shared_ptr<VirtualMachineRolePoolXML> vm_roles_pool, std::ostringstream& oss)
{
    /* ---------------------------------------------------------------------- */
