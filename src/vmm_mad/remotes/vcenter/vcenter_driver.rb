...
class VCenterVm
    ...
    def info
      ...
      #str_info << "#{POLL_ATTRIBUTE[:diskrdbytes]}=" << @diskrdbytes.to_s << " "
      #str_info << "#{POLL_ATTRIBUTE[:diskwrbytes]}=" << @diskwrbytes.to_s << " "
      #str_info << "#{POLL_ATTRIBUTE[:diskrdiops]}="  << @diskrdiops.to_s  << " "
      #str_info << "#{POLL_ATTRIBUTE[:diskwriops]}="  << @diskwriops.to_s  << " "
