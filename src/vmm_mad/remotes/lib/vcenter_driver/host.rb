    ...
    class ClusterComputeResource
            ...
            extension_list.each do |ext_list|
                if ext_list.key == NSXDriver::NSXConstants::NSXV_EXTENSION_LIST
                    ...
                    nsx_obj['label'] = ext_list.description.label
                      ...
                      NSXDriver::NSXConstants::NSXT_EXTENSION_LIST
        ...
        def tz_get
            ...
            if !nsx_ready?
                ...
                if @one_item['TEMPLATE/NSX_TYPE'] ==
                   NSXDriver::NSXConstants::NSXV
                    tzs = tz_object.tzs
                    tzs.each do |tz|
                    ...
                    tz_info.chomp!(',')
                elsif @one_item['TEMPLATE/NSX_TYPE'] ==
                      NSXDriver::NSXConstants::NSXT
                    r = tz_object.tzs
