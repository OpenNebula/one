 ...
 * ------------------------------------------------------------------------- */
import General from '@modules/resources/OneKs/Forms/CreateOneKsClusterForm/Steps/General'
import Cluster from '@modules/resources/OneKs/Forms/CreateOneKsClusterForm/Steps/Cluster'
import Public from '@modules/resources/OneKs/Forms/CreateOneKsClusterForm/Steps/Public'
import Private from '@modules/resources/OneKs/Forms/CreateOneKsClusterForm/Steps/Private'
// import Family from '@modules/resources/OneKs/Forms/CreateOneKsClusterForm/Steps/Family'
import Flavours from '@modules/resources/OneKs/Forms/CreateOneKsClusterForm/Steps/Flavours'
import UserInputs from '@modules/resources/OneKs/Forms/CreateOneKsClusterForm/Steps/UserInputs'
import KubernetesVersion from '@modules/resources/OneKs/Forms/CreateOneKsClusterForm/Steps/KubernetesVersion'
