...
import {
  ACLDocumentation,
  ACLRulePreview,
} from '@modules/resources/ACLs/Forms/CreateForm/Utils/helper'

export const STEP_ID = 'zone'

const Content = (oneConfig, users, groups, clusters, zones) => (
  <Grid mt={2} container>
    <Grid item xs={12}>
      <ACLRulePreview
        users={users}
...
const Zone = ({ oneConfig, users, groups, clusters, zones, version }) => ({
  ...
  content: () => Content(oneConfig, users, groups, clusters, zones),
  documentation: {
