...
import BasicConfiguration, {
  STEP_ID as BASIC_ID,
} from '@modules/resources/VrTemplate/Forms/InstantiateForm/Steps/BasicConfiguration'
import Networking from '@modules/resources/VrTemplate/Forms/InstantiateForm/Steps/Networking'
import TemplateSelection from '@modules/resources/VrTemplate/Forms/InstantiateForm/Steps/TemplateSelection'
import UserInputs from '@modules/resources/VrTemplate/Forms/InstantiateForm/Steps/UserInputs'
import {
  userInputsToArray,
  createSteps,
...
const Steps = createSteps(
  ({ dataTemplateExtended = {}, isEmptyTemplate, ...rest }) => {
    ...
    // Group user inputs
    const userInputsLayout = groupTemplateUserInputs(
      userInputs,
      userInputsMetadata
    )
