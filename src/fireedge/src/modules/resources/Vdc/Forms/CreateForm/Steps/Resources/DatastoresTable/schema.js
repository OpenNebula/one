 ...
 * ------------------------------------------------------------------------- */
import { CLUSTER_FIELD_NAME } from '@modules/resources/Vdc/Forms/CreateForm/Steps/Resources/ClustersTable/schema'
import { ZONE_FIELD_NAME } from '@modules/resources/Vdc/Forms/CreateForm/Steps/Resources/ZonesSelect/schema'
...
const DATASTORE = (zoneId) => ({
  ...
  model: getDatastoreModel(zoneId),
