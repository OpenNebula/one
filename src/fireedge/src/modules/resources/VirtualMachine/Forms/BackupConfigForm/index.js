...
import ContentForm from '@modules/resources/VirtualMachine/Forms/BackupConfigForm/content'
import {
  DISK_IDS_FIELD,
  INCLUDE_ALL_DISKS_FIELD,
  SCHEMA,
} from '@modules/resources/VirtualMachine/Forms/BackupConfigForm/schema'
