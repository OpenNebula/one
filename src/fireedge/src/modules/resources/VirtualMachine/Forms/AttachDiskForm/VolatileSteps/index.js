...
import BasicConfiguration, {
  STEP_ID as BASIC_ID,
} from '@modules/resources/VirtualMachine/Forms/AttachDiskForm/VolatileSteps/BasicConfiguration'
import AdvancedOptions, {
  STEP_ID as ADVANCED_ID,
} from '@modules/resources/VirtualMachine/Forms/AttachDiskForm/VolatileSteps/AdvancedOptions'
...
const Steps = createSteps([BasicConfiguration, AdvancedOptions], {
  ...
  transformBeforeSubmit: (formData) => {
    ...
    return {
      template: jsonToXml({
        DISK: { ...mapUserInputs(advanced), ...mapUserInputs(configuration) },
      }),
    }
  },
})
