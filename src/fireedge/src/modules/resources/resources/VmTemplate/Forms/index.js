...
const CloneForm = (configProps) =>
  AsyncLoadForm({ formPath: 'VmTemplate/Forms/CloneForm' }, configProps)
...
const DeleteForm = (configProps) =>
  AsyncLoadForm({ formPath: 'VmTemplate/Forms/DeleteForm' }, configProps)
...
const InstantiateForm = (configProps) =>
  AsyncLoadForm({ formPath: 'VmTemplate/Forms/InstantiateForm' }, configProps)
