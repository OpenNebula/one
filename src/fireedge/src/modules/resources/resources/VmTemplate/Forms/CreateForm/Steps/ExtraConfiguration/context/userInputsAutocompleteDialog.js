...
const PopUpDialog = ({ open, handleClose }) => {
  ...
  const [fetchVRTemplates, { isFetching }] =
    VrTemplateAPI.useLazyGetVrTemplatesQuery(undefined, {
      skip: true,
    })
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        <Button type={STYLE_BUTTONS.TYPE.SECONDARY} onClick={handleClose}>
          Cancel
        </Button>
        <Button type={STYLE_BUTTONS.TYPE.SECONDARY} onClick={handleSubmit}>
          Add
        </Button>
      </DialogActions>
    </Dialog>
