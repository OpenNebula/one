...
import GuacamoleClient, {
  GuacamoleClientType,
} from '@modules/resources/resources/VirtualMachine/Consoles/Guacamole/client'
import {
  GuacamoleDisplayPlugin,
  GuacamoleKeyboardPlugin,
  GuacamoleMousePlugin,
} from '@modules/resources/resources/VirtualMachine/Consoles/Guacamole/plugins'
import {
  reducePlugin,
  useGetLatest,
} from '@modules/resources/resources/VirtualMachine/Consoles/utils'
...
export * from '@modules/resources/resources/VirtualMachine/Consoles/Guacamole/buttons'
export * from '@modules/resources/resources/VirtualMachine/Consoles/Guacamole/plugins'
