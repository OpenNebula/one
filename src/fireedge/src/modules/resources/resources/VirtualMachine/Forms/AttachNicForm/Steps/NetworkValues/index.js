...
import {
  SCHEMA,
  SECTIONS,
} from '@modules/resources/resources/VirtualMachine/Forms/AttachNicForm/Steps/NetworkValues/schema'
import { FormWithSchema } from '@ComponentsV2Module'
import { Step } from '@UtilsModule'
import { T, Nic, HYPERVISORS } from '@ConstantsModule'

export const STEP_ID = 'network-values'
 ...
 */
const NetworkValues = (props) => ({
  id: STEP_ID,
  label: T.NetworkValues,
