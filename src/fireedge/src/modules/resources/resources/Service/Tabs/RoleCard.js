...
/**
 * ServiceRoleCard component displays a Service role as a card.
 *
          ...
          [
            MetadataSlot,
            {
              labels: [
                ...
                [
                  T.RolesMinVms,
                  minVms === undefined || minVms === null || minVms === ''
                    ? undefined
                    : String(minVms),
                ],
                [
                  T.RolesMaxVms,
                  maxVms === undefined || maxVms === null || maxVms === ''
                    ? undefined
                    : String(maxVms),
                ],
              ].filter(
