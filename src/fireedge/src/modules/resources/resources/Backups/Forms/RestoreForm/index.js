...
} from '@modules/resources/resources/Backups/Forms/RestoreForm/Steps/BackupsTable'
import BasicConfiguration, {
  STEP_ID as BASIC_ID,
} from '@modules/resources/resources/Backups/Forms/RestoreForm/Steps/BasicConfiguration'
import DatastoresTable, {
  STEP_ID as DATASTORE_ID,
} from '@modules/resources/resources/Backups/Forms/RestoreForm/Steps/DatastoresTable'
import VmDisksTable, {
  STEP_ID as VM_DISK_ID,
} from '@modules/resources/resources/Backups/Forms/RestoreForm/Steps/VmDisksTable'
...
const Steps = createSteps(
  [BackupsTable, BasicConfiguration, VmDisksTable, DatastoresTable],
  {
    ...
    transformBeforeSubmit: (formData) => {
      ...
      const selectedDisk = Array.isArray(individualDisk)
        ? individualDisk?.[0]
        : individualDisk

      return {
        datastore: datastore?.ID,
        individualDisk: selectedDisk ?? '-1',
