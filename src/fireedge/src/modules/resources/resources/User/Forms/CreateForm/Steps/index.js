...
} from '@modules/resources/resources/User/Forms/CreateForm/Steps/General'
import SecondaryGroups, {
  FIELD_NAME as SECONDARY_GROUPS_FIELD,
  STEP_ID as SECONDARY_GROUPS_ID,
} from '@modules/resources/resources/User/Forms/CreateForm/Steps/SecondaryGroups'
import PrimaryGroup, {
  FIELD_NAME as PRIMARY_GROUP_FIELD,
  STEP_ID as PRIMARY_GROUP_ID,
} from '@modules/resources/resources/User/Forms/CreateForm/Steps/PrimaryGroup'
...
const Steps = createSteps([General, PrimaryGroup, SecondaryGroups], {
  transformBeforeSubmit: (formData) => {
    ...
    const primaryGroup = primaryGroupsData?.[PRIMARY_GROUP_FIELD]
    const secondaryGroups = []
      .concat(secondaryGroupsData?.[SECONDARY_GROUPS_FIELD] ?? [])
    ...
    return {
      ...
      group: [primaryGroup, ...secondaryGroups],
    }
  },
})
