  ...
  return (
    <>
      <AlertNotification
        type="primary"
        status="information"
        description={translate(T['oneks.form.create.public.help.paragraph'])}
        isDismissible={false}
...
/**
 * Public Vnets Cluster configuration.
 *
 * @returns {object} Vnets configuration step
 */
const Public = () => ({
  id: STEP_ID,
  label: T.SelectPublicVirtualNetworks,
  resolver: SCHEMA,
