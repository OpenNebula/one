...
export const getStyles = ({ theme }) => ({
  ...
  '& .capacity-card .details-container': {
    display: 'grid',
  ...
  '& .datastore-row': {
    ...
    gridTemplateColumns: {
      xs: '1fr',
      sm: 'minmax(180px, 280px) minmax(0, 1fr)',
    },
    alignItems: 'center',
    gap: '12px',
    minWidth: 0,
  ...
  '& .capacity-value .toggle-group-container': {
    marginLeft: 'auto',
  },
  ...
  '& .datastore-progress [role="progressbar"]': {
    flexDirection: 'row',
    alignItems: 'center',
    gap: '8px',
  },

  '& .datastore-progress .progress-track': {
    order: 1,
    flex: '1 1 auto',
    width: 'auto',
  },

  '& .datastore-progress .progress-label': {
    order: 2,
    flex: '0 0 auto',
    whiteSpace: 'nowrap',
  },
