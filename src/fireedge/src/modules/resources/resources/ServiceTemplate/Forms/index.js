...
const CloneForm = (configProps) =>
  AsyncLoadForm({ formPath: 'ServiceTemplate/Forms/CloneForm' }, configProps)
...
const CreateForm = (configProps) =>
  AsyncLoadForm({ formPath: 'ServiceTemplate/Forms/CreateForm' }, configProps)
...
const InstantiateForm = (configProps) =>
  AsyncLoadForm(
    { formPath: 'ServiceTemplate/Forms/InstantiateForm' },
    configProps
  )
