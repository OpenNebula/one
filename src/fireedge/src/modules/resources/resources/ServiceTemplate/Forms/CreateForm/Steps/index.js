...
} from '@modules/resources/resources/ServiceTemplate/Forms/CreateForm/Steps/General'

import Extra, {
  STEP_ID as EXTRA_ID,
} from '@modules/resources/resources/ServiceTemplate/Forms/CreateForm/Steps/Extra'

import { TAB_ID as ADVANCED_ID } from '@modules/resources/resources/ServiceTemplate/Forms/CreateForm/Steps/Extra/advancedParams'

import { TAB_ID as NETWORK_ID } from '@modules/resources/resources/ServiceTemplate/Forms/CreateForm/Steps/Extra/networking'

import { SECTION_ID as NETWORKS_VALUES_ID } from '@modules/resources/resources/ServiceTemplate/Forms/CreateForm/Steps/Extra/networking/extraDropdown'
...
const Steps = createSteps([General, Extra, Roles], {
  transformInitialValue: (ServiceTemplate, schema) => {
    const name = ServiceTemplate?.NAME ?? ''
    const template = ServiceTemplate?.TEMPLATE?.BODY ?? {}
    const description = ServiceTemplate?.DESCRIPTION ?? template?.description
