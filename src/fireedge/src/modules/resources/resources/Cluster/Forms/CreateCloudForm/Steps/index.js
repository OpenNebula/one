...
} from '@modules/resources/resources/Cluster/Forms/CreateCloudForm/Steps/General'
import ProvidersStep, {
  STEP_ID as PROVIDER_ID,
} from '@modules/resources/resources/Cluster/Forms/CreateCloudForm/Steps/ProvidersTable'

import Deployments, {
  STEP_ID as DEPLOYMENT_ID,
} from '@modules/resources/resources/Cluster/Forms/CreateCloudForm/Steps/Deployments'

import UserInputs, {
  STEP_ID as USER_INPUTS_ID,
} from '@modules/resources/resources/Cluster/Forms/CreateCloudForm/Steps/UserInputs'

import OneformTags, {
  STEP_ID as TAGS_ID,
} from '@modules/resources/resources/Cluster/Forms/CreateCloudForm/Steps/OneFormTags'
