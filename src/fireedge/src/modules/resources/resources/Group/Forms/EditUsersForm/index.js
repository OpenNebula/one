...
import {
  FIELDS,
  SCHEMA,
} from '@modules/resources/resources/Group/Forms/EditUsersForm/schema'
...
const EditUsersForm = createForm(SCHEMA, FIELDS, {
  transformInitialValue: (users, schema) => ({
    ...schema.cast({ users: normalizeUserIds(users) }, { stripUnknown: false }),
  }),
  transformBeforeSubmit: (formData) => normalizeUserIds(formData?.users),
})
