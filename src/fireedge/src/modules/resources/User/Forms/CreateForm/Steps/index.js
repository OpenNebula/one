...
} from '@modules/resources/User/Forms/CreateForm/Steps/General'
import SecondaryGroups, {
  FIELD_NAME as SECONDARY_GROUPS_FIELD,
  STEP_ID as SECONDARY_GROUPS_ID,
} from '@modules/resources/User/Forms/CreateForm/Steps/SecondaryGroups'
import PrimaryGroup, {
  FIELD_NAME as PRIMARY_GROUP_FIELD,
  STEP_ID as PRIMARY_GROUP_ID,
} from '@modules/resources/User/Forms/CreateForm/Steps/PrimaryGroup'
