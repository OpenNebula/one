...
import { PermissionsTab, OwnershipTab } from '@ComponentsModule'
import { Stack } from '@mui/material'
import PropTypes from 'prop-types'
import { Component, useMemo } from 'react'
import { getStyles } from '@modules/resources/ServiceTemplate/Tabs/Info/styles'
 ...
 * @returns {Component} - Sercvice Templates info tab
 */
    ...
    <Stack key={'Permissions-Tab'} sx={(theme) => getStyles({ theme })}>
      {permissionsPanel?.enabled && (
        <PermissionsTab
          ...
          isDisabled={isMutating || isActionsDisabled}
        />
      )}
