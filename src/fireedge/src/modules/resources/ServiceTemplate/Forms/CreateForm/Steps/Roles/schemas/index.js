...
import {
  ...
  getDefaultRole,
} from '@modules/resources/ServiceTemplate/Forms/CreateForm/Steps/Roles/schemas/roleDefinition'

import {
  ADVANCED_PARAMS_SCHEMA,
  ADVANCED_PARAMS_FIELDS,
} from '@modules/resources/ServiceTemplate/Forms/CreateForm/Steps/Roles/schemas/advancedParameters'

import {
  ELASTICITY_POLICY_SCHEMA,
  SECTION_ID as EPOLICY_ID,
} from '@modules/resources/ServiceTemplate/Forms/CreateForm/Steps/Roles/dropdowns/sections/elasticity/schema'

import {
  SCHEDULED_POLICY_SCHEMA,
  SECTION_ID as SPOLICY_ID,
} from '@modules/resources/ServiceTemplate/Forms/CreateForm/Steps/Roles/dropdowns/sections/scheduled/schema'

import { MIN_MAX_SCHEMA } from '@modules/resources/ServiceTemplate/Forms/CreateForm/Steps/Roles/dropdowns/sections/minMax'
...
export { getDefaultRole, TEMPLATE_ID_FIELD }
