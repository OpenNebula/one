...
} from '@modules/resources/ServiceTemplate/Forms/InstantiateForm/Steps/General'

import NetworksStep, {
  STEP_ID as NETWORK_ID,
} from '@modules/resources/ServiceTemplate/Forms/InstantiateForm/Steps/Networks'
...
} from '@modules/resources/ServiceTemplate/Forms/InstantiateForm/Steps/UserInputs'

import UserInputsRole, {
  STEP_ID as USERINPUTSROLE_ID,
} from '@modules/resources/ServiceTemplate/Forms/InstantiateForm/Steps/UserInputsRole'

import Charter, {
  STEP_ID as CHARTER_ID,
} from '@modules/resources/ServiceTemplate/Forms/InstantiateForm/Steps/Charters'
...
import {
  ...
  toNetworkString,
  groupServiceTemplateUserInputs,
} from '@UtilsModule'

const Steps = createSteps(
  (data) => {
    // Get and order user inputs
    const userInputsData = groupServiceTemplateUserInputs(data?.dataTemplate)
