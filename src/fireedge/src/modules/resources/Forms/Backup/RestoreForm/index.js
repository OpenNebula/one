...
} from '@modules/resources/Forms/Backup/RestoreForm/Steps/BackupsTable'
import BasicConfiguration, {
  STEP_ID as BASIC_ID,
} from '@modules/resources/Forms/Backup/RestoreForm/Steps/BasicConfiguration'
import DatastoresTable, {
  STEP_ID as DATASTORE_ID,
} from '@modules/resources/Forms/Backup/RestoreForm/Steps/DatastoresTable'
import VmDisksTable, {
  STEP_ID as VM_DISK_ID,
} from '@modules/resources/Forms/Backup/RestoreForm/Steps/VmDisksTable'
