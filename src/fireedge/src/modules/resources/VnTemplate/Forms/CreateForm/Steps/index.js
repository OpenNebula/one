 ...
 * ------------------------------------------------------------------------- */
import Configuration from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/Configuration'
import { STEP_ID as EXTRA_ID } from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/Configuration/constants'
import General, {
  STEP_ID as GENERAL_ID,
} from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/General'
import { VN_DRIVERS } from '@ConstantsModule'
import { jsonToXml, createSteps } from '@UtilsModule'
import {
  getUnknownVars,
  normalizeAttributeList,
} from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/Configuration/utils'
