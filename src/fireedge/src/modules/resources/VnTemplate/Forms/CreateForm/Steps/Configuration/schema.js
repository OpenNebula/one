...
import { SCHEMA as AR_SCHEMA } from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/Configuration/addresses/schema'
import { SCHEMA as CLUSTER_SCHEMA } from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/Configuration/clusters/schema'
import { SCHEMA as CONTEXT_SCHEMA } from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/Configuration/context/schema'
import { SCHEMA as QOS_SCHEMA } from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/Configuration/qos/schema'
import { SCHEMA as SECURITY_SCHEMA } from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/Configuration/security/schema'
import {
  SCHEMA as CONFIGURATION_SCHEMA,
  SCHEMA_INSTANTIATE as INSTANTIATE_CONFIGURATION_SCHEMA,
} from '@modules/resources/VnTemplate/Forms/CreateForm/Steps/Configuration/Network/schema'
