...
import ServiceColumns from '@modules/resources/Tables/Services/columns'
import ServiceRow from '@modules/resources/Tables/Services/row'
  ...
  const listHeader = [
    ...
    { header: T.Name, id: 'name', accessor: 'NAME' },
    {
      ...
      accessor: ({ TEMPLATE: { BODY: { start_time: startTime } = {} } }) => {
        const time = timeFromMilliseconds(+startTime)
