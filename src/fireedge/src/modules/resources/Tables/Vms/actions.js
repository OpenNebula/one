...
import VmTemplatesTable from '@modules/resources/Tables/Vms/VmTemplateTable'
import VmsConsoleTable from '@modules/resources/Tables/Vms/consoleTable'
      ...
      createActions({
        ...
        actions: [
          ...
          },
          {
            ...
            selected: true,
            dataCy: 'vm-manage',
            variant: STYLE_BUTTONS.TYPE.OUTLINE,
            startIcon: Settings,
            options: [
              {
