  ...
  return (
    ...
    >
      <Box
        ...
        sx={{
          paddingLeft: isHovered || isFixMenu ? '0.75rem' : '0',
          borderBottom: `${theme.scale[25]}px solid ${theme.palette.border.primary}`,
        }}
      >
        <OpenNebulaLogo
          width="100px"
