...
import ContentForm, {
  CUSTOM_ATTRS_ID,
} from '@modules/resources/VirtualNetwork/Forms/AddRangeForm/content'
import {
  FIELDS,
  SCHEMA,
} from '@modules/resources/VirtualNetwork/Forms/AddRangeForm/schema'
import {
  dialogContentMaxHeight,
  dialogMaxWidth,
  dialogWidth,
} from '@modules/resources/VirtualNetwork/Forms/AddRangeForm/styles'
