 ...
 */
const ActionButton = ({ action, name, icon, handleClick, ...props }) => {
  const dataCy = useMemo(() => getAttributeCy(action, name), [name])

  return (
    <Action cy={dataCy} iconStart={icon} handleClick={handleClick} {...props} />
  )
}
 ...
 */
const Add = (props) => (
  <ActionButton action="add" iconOnly={AddIcon} {...props} />
)
 ...
 */
const Edit = (props) => (
  <ActionButton action="edit" iconOnly={EditIcon} {...props} />
)
 ...
 */
const Delete = (props) => (
  <ActionButton action="delete" iconOnly={DeleteIcon} {...props} />
)
 ...
 */
const Accept = (props) => (
  <ActionButton action="accept" iconOnly={AcceptIcon} {...props} />
)
 ...
 */
const Cancel = (props) => (
  <ActionButton action="cancel" iconOnly={CancelIcon} {...props} />
)
