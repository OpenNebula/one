...
import ImageSnapshotCard from '@modules/resources/Cards/ImageSnapshotCard'
import {
  SnapshotFlattenAction,
  SnapshotDeleteAction,
  SnapshotRevertAction,
} from '@modules/resources/Tabs/Image/Snapshots/Actions'
...
const ImageStorageTab = ({ tabProps: { actions } = {}, id }) => {
  ...
  return (
    <div>
      <Stack direction="row" gap="1em" py="0.8em">
        {snapshots.length ? (
