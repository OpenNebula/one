...
import { ButtonGenerator } from '@modules/resources/Tabs/Service/ButtonGenerator'
...
import RoleStep from '@modules/resources/resources/ServiceTemplate/Forms/CreateForm/Steps/Roles'
import { ScaleDialog } from '@modules/resources/Tabs/Service/ScaleDialog'
...
const AddRoleDialog = ({ open, onClose, onSubmit }) => {
  const methods = useForm({
    mode: 'onSubmit',
    defaultValues: { roles: rolesResolver.default() },
    ...
    >
      <Box mr={2} mt={-1} alignSelf="start">
        <StatusCircle
          ...
          tooltip={getRoleState(status)?.displayName}
        />
      </Box>
