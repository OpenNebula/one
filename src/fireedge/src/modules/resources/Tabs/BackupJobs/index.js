...
import Info from '@modules/resources/Tabs/BackupJobs/Info'
import SchedActions from '@modules/resources/Tabs/BackupJobs/SchedActions'
import VMs from '@modules/resources/Tabs/BackupJobs/VMs'
          ...
          <Alert
            ...
            action={
              <SubmitButton
                ...
                onClick={handleRetry}
                iconOnly={<Translate word={T.Retry} />}
