...
import {
  ...
  DeleteSchedButton,
  UpdateSchedButton,
} from '@modules/resources/Buttons/ScheduleAction'
import ScheduleActionCard from '@modules/resources/Cards/ScheduleActionCard'
...
const BackupJobSchedulingTab = ({ tabProps: { actions } = {}, id }) => {
  ...
  const { data: backupjob = {} } = BackupJobAPI.useGetBackupJobQuery({ id })
