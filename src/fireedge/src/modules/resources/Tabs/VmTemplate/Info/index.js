...
import { Permissions, Ownership } from '@modules/resources/Tabs/Common'
import Information from '@modules/resources/Tabs/VmTemplate/Info/information'
...
const VmTemplateInfoTab = ({ tabProps = {}, id, oneConfig, adminGroup }) => {
  ...
  const { data: template = {} } = VmTemplateAPI.useGetTemplateQuery({ id })
