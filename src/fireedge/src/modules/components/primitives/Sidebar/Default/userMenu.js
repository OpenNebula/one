...
import {
  MenuDropdown,
  DropdownItem,
} from '@modules/components/primitives/Dropdown'
import { Switch } from '@modules/components/primitives/Buttons/Switch/Default'
...
/**
 * Footer user trigger and menu shell for the design-system sidebar.
 *
