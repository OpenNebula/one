...
import { DRIVER_FIELD } from '@modules/components/Forms/VNetwork/CreateForm/Steps/General/informationSchema'
import { Field, arrayToOptions } from '@UtilsModule'
import { T, INPUT_TYPES, VN_DRIVERS } from '@ConstantsModule'
...
const FILTER_MAC_SPOOFING_FIELD = {
  ...
  type: INPUT_TYPES.SWITCH,
  onlyOnHypervisors: [fw, dot1Q, vxlan, ovswitch, openVSwitchVXLAN],
