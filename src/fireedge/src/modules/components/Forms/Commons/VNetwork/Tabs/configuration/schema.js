 ...
 * VXLAN_MC                                                O                                            X
 * IP_LINK_CONF                                            O                                            X
 * ENABLE_DPDK (send BRIDGE_TYPE)                                    O
 */
...
/**
 * @type {Field} Enable DPDK
 *
 * BRIDGE_TYPE is an attribute that will be generated by the core when creating a vnet but, if the user wants to enable DPDK, the BRIDGE_TYPE will be send to the core in order to override the value.
 * BRIDGE_TYPE will be 'openvswitch_dpdk' when the user selects VN_MAD=ovswitch or VN_MAD=ovswitch_vxlan and DPDK is enabled.
 */
const ENABLE_DPDK = {
  name: 'ENABLE_DPDK',
  label: T.DPDK,
