...
} from '@modules/components/Forms/Provider/CreateForm/Steps/Template'
import BasicConfiguration, {
  STEP_ID as BASIC_ID,
} from '@modules/components/Forms/Provider/CreateForm/Steps/BasicConfiguration'
import Connection, {
  STEP_ID as CONNECTION_ID,
} from '@modules/components/Forms/Provider/CreateForm/Steps/Connection'
