  ...
  return (
    <>
      <Alert severity="info" variant="outlined" className={classes.groupInfo}>
        ...
        >
          <div>{Tr(T['oneks.form.create.private.help.paragraph'])}</div>
        </Stack>
      </Alert>
...
/**
 * Private Vnets Cluster configuration.
 *
 * @returns {object} Vnets configuration step
 */
const Private = () => ({
  id: STEP_ID,
  label: T.SelectPrivateVirtualNetworks,
  resolver: SCHEMA,
