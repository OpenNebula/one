 ...
 */
const createFieldsFromFlavoursOdsUserInputs = (drivers = []) => {
...
/**
 * Create an object with the fields for each available family and flavours configuration
 ...
 */
const createFieldsFromFlavoursConfs = (drivers = []) => {
  const driverNames = drivers.map((driver) => driver.name)
...
export { createFieldsFromFlavoursOdsUserInputs, createFieldsFromFlavoursConfs }
