...
const Content = (providersSteps) => (
  <FormWithSchema
    id={STEP_ID}
    cy={`${STEP_ID}`}
    fields={FIELDS(providersSteps)}
  />
)
 ...
 *
 * @param {object} steps - Next steps associated for providers
 * @param {boolean} onpremiseProvider - Use onpremise provider
 * @returns {object} Drivers table selector step
 */
const ProvidersStep = (steps, onpremiseProvider) => ({
  id: STEP_ID,
