...
import { Tooltip as OpenNebulaTooltip } from '@modules/components/primitives/Tooltip/Default'
...
import {
  FormatPolarDataset,
  PolarTooltip,
} from '@modules/components/composed/Charts/MultiChart/helpers/subComponents'
        ...
        <ChartComponent {...chartConfig}>
          ...
          <Tooltip
            content={
              coordinateType === 'CARTESIAN' ? (
                <OpenNebulaTooltip
                  title={datasets.map((ds) => sentenceCase(ds.label))}
