...
import { Badge } from '@modules/components/primitives/Badge/Default'
import { Button } from '@modules/components/primitives/Buttons/Default'
import { Dialog } from '@modules/components/primitives/Dialog'
import { ToggleGroup } from '@modules/components/primitives/Buttons/Toggle/Group'
import { InputField } from '@modules/components/primitives/Fields/Default'
import { Table } from '@modules/components/primitives/Tables/Default'
import {
  ACTION_GROUP_STYLES,
  ACTION_STYLES,
  DESTRUCTIVE_ACTION_STYLES,
} from '@modules/components/composed/Panels/Attributes/styles'
import {
  getDialogContentStyles,
  getManageStyles,
} from '@modules/components/composed/LabelPanel/styles'
import {
  filterLabelRows,
  getLabelRows,
