...
import { VdcAPI, oneApi } from '@FeaturesModule'
import { VirtualDataCenterCard } from '@modules/components/Cards'
...
const Row = memo(
  ({
    ...
    const state = oneApi.endpoints.getVDCs.useQueryState(undefined, {
