...
import { VmTemplateCard as VrTemplateCard } from '@modules/components/Cards'
...
const Row = memo(
  ({
    ...
    const state = oneApi.endpoints.getVrTemplates.useQueryState(undefined, {
