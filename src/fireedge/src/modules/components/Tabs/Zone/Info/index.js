...
import Information from '@modules/components/Tabs/Zone/Info/information'
import ServerPool from '@modules/components/Tabs/Zone/Info/ServerPool'
...
const ZoneInfoTab = ({ tabProps = {}, id }) => {
  ...
  const [update] = ZoneAPI.useUpdateZoneMutation()
  const { data: zone = {} } = ZoneAPI.useGetZoneQuery(id)
  const { TEMPLATE } = zone
