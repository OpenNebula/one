...
import Information from '@modules/components/Tabs/VNetwork/Info/information'
import QOS from '@modules/components/Tabs/VNetwork/Info/qos'
...
const VNetworkInfoTab = ({ tabProps = {}, id, oneConfig, adminGroup }) => {
  ...
  const [changePermissions] = VnAPI.useChangeVNetPermissionsMutation()
