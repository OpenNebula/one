...
import Information from '@modules/components/Tabs/Vdc/Info/information'
...
const VDCInfoTab = ({ tabProps = {}, id }) => {
  ...
  const { data: vdc = {} } = VdcAPI.useGetVDCQuery({ id })
  const { TEMPLATE } = vdc
  const [updateTemplate] = VdcAPI.useUpdateVDCMutation()
