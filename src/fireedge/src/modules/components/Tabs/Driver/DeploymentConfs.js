    ...
    <Accordion variant="outlined" expanded>
      <AccordionDetails>
        <Box component="pre">
          ...
          >
            {JSON.stringify(driver?.deployment_confs ?? {}, null, 2)}
          </Box>
        </Box>
      </AccordionDetails>
    </Accordion>
...
DeploymentConfsTab.propTypes = {
  tabProps: PropTypes.object,
  id: PropTypes.string,
}

DeploymentConfsTab.displayName = 'DeploymentConfsTab'

export default DeploymentConfsTab
