...
import { timeToString, booleanToString } from '@ModelsModule'
import { T, VM_TEMPLATE_ACTIONS, ServiceTemplate } from '@ConstantsModule'
...
const InformationPanel = ({ template = {}, actions }) => {
  const [renameTemplate] = ServiceTemplateAPI.useRenameServiceTemplateMutation()
