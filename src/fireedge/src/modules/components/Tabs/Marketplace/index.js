...
import Info from '@modules/components/Tabs/Marketplace/Info'
import MarketplaceApps from '@modules/components/Tabs/Marketplace/MarketplaceApps'
...
const MarketplaceTabs = memo(({ id }) => {
  ...
  const { isError, error, status, data } =
    MarketplaceAPI.useGetMarketplaceQuery({ id })
