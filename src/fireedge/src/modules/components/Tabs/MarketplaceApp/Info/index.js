...
import Information from '@modules/components/Tabs/MarketplaceApp/Info/information'

import { Tr } from '@modules/components/HOC'
import { T } from '@ConstantsModule'
import { getActionsAvailable, filterAttributes, jsonToXml } from '@ModelsModule'
...
const MarketplaceAppInfoTab = ({ tabProps = {}, id }) => {
  ...
  const [updateTemplate] = MarketplaceAppAPI.useUpdateAppMutation()
  const { data: app = {} } = MarketplaceAppAPI.useGetMarketplaceAppQuery({ id })
