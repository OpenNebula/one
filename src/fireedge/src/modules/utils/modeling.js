 ...
 * @returns {object[]} - Tabs enabled in the view configuration
 */
export const getAvailableInfoTabsV2 = (configTabs = {}, tabs = {}) =>
  Object.entries(configTabs)
    ?.filter(([_, config]) => config === true || config?.enabled === true)
