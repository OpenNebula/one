...
import { responseDataToArray } from '@modules/utils/helpers'
import { userInputsToArray } from '@modules/utils/modeling'
import { arrayToOptions, Field } from '@modules/utils/schema'
import { stringToBoolean } from '@modules/utils/string'
 ...
 */
const createFieldsFromTemplateUserInputs = (
  userInputs = [],
  userInputsLayout,
 ...
 */
const groupTemplateUserInputs = (userInputs, userInputsMetadata, prefix) => {
 ...
 */
const groupServiceTemplateUserInputs = (service) => {
  ...
  const serviceUserInputsLayout = groupTemplateUserInputs(
    serviceUserInputs,
  ...
  service?.TEMPLATE?.BODY?.roles?.forEach((role) => {
    ...
    const roleUserInputsLayout = groupTemplateUserInputs(
      roleUserInputs,
...
export {
  createFieldsFromTemplateUserInputs,
  groupTemplateUserInputs,
