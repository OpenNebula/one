...
} from 'client/features/OneApi/vrouter'
...
import Information from 'client/components/Tabs/VirtualRouter/Info/information'
...
const VRouterInfoTab = ({ tabProps = {}, id }) => {
  ...
  const [changePermissions] = useChangeVRouterPermissionsMutation()
  const [changeOwnership] = useChangeVRouterOwnershipMutation()
  const [updateVRouterTemplate] = useUpdateVRouterMutation()
