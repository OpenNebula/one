...
const { defaultOneKsServer } = require('server/utils/constants/defaults')
...
const oneKsConnection = (
  ...
  const options = {
    method: optionMethod,
    baseURL: `${appConfig.oneks_server || defaultOneKsServer}`,
