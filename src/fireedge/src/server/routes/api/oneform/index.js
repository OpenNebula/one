...
const provisionEndpoints = [
  ...
  {
    action: provisionAddHosts,
    ...CommandsProvision[ActionsProvision.ADD_HOSTS],
  },
  {
    action: provisionDeleteHosts,
    ...CommandsProvision[ActionsProvision.DELETE_HOSTS],
  },
  {
    action: provisionAddPublicIps,
    ...CommandsProvision[ActionsProvision.ADD_PUBLIC_IPS],
  },
  {
    action: provisionDeletePublicIp,
    ...CommandsProvision[ActionsProvision.DELETE_PUBLIC_IP],
  },
  {
