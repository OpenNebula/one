...
const string xmls[] =
{
    "<VM><ID>0</ID><UID>123</UID><GID>1</GID><NAME>VM one</NAME><LAST_POLL>0</LAST_POLL><ST"
    ...
    "<VM><ID>1</ID><UID>261</UID><GID>1</GID><NAME>Second VM</NAME><LAST_POLL>0</LAST_POLL>"
