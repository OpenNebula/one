...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OBRACKET = 5,                   /* "'['"  */
  YYSYMBOL_CBRACKET = 6,                   /* "']'"  */
  YYSYMBOL_EQUAL_EMPTY = 7,                /* "'=' followed by a newline"  */
  YYSYMBOL_CCDATA = 8,                     /* "']]>'"  */
  YYSYMBOL_STRING = 9,                     /* "attribute value"  */
  YYSYMBOL_VARIABLE = 10,                  /* "attribute name"  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_template_file = 12,             /* template_file  */
  YYSYMBOL_template = 13,                  /* template  */
  YYSYMBOL_attribute = 14,                 /* attribute  */
  YYSYMBOL_array_val = 15                  /* array_val  */
};
...
{
       0,    98,    98,    99,   102,   103,   106,   116,   129,   138,
     148,   154,   167
};
#endif
...
static const char *const yytname[] =
{
  ...
  "\"attribute value\"", "\"attribute name\"", "$accept", "template_file",
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Kind, Value, Location, mc, tmpl, error_msg, scanner); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, mem_collector * mc, Template * tmpl, char ** error_msg, yyscan_t scanner)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yylocationp);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, mem_collector * mc, Template * tmpl, char ** error_msg, yyscan_t scanner)
{
  ...
  YYFPRINTF (yyo, ": ");
  yy_symbol_value_print (yyo, yykind, yyvaluep, yylocationp, mc, tmpl, error_msg, scanner);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp,
                 int yyrule, mem_collector * mc, Template * tmpl, char ** error_msg, yyscan_t scanner)
{
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, mem_collector * mc, Template * tmpl, char ** error_msg, yyscan_t scanner)
{
  YY_USE (yyvaluep);
  YY_USE (yylocationp);
  YY_USE (mc);
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* attribute: "attribute name" "'='" "attribute value"  */
#line 107 "template_syntax.y"
            {
                Attribute * pattr;
...
#line 1519 "template_syntax.cc"
    break;

  case 7: /* attribute: "attribute name" "'='" "'['" array_val "']'"  */
...
#line 1536 "template_syntax.cc"
    break;

  case 8: /* attribute: "attribute name" "'='" "'['" "']'"  */
#line 130 "template_syntax.y"
            {
                Attribute * pattr;
...
#line 1549 "template_syntax.cc"
    break;

  case 9: /* attribute: "attribute name" "'=' followed by a newline"  */
#line 139 "template_syntax.y"
            {
                Attribute * pattr;
...
#line 1563 "template_syntax.cc"
    break;

  case 10: /* attribute: "attribute name" "'='" "']]>'"  */
#line 149 "template_syntax.y"
            {
                YYABORT;
            }
#line 1571 "template_syntax.cc"
    break;

  case 11: /* array_val: "attribute name" "'='" "attribute value"  */
#line 155 "template_syntax.y"
            {
...
#line 1588 "template_syntax.cc"
    break;

  case 12: /* array_val: array_val "','" "attribute name" "'='" "attribute value"  */
#line 168 "template_syntax.y"
            {
                string               name((yyvsp[-2].val_str));
                string               value((yyvsp[0].val_str));
...
#line 1605 "template_syntax.cc"
    break;


#line 1609 "template_syntax.cc"
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, yylsp, mc, tmpl, error_msg, scanner);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, yylsp, mc, tmpl, error_msg, scanner);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
