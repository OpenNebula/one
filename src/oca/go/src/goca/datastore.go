...
func (c *Controller) DatastorePool() *DatastoresController {
...
// DatastoreByName returns a Datastore ID from name
func (c *Controller) DatastoreByName(name string) (uint, error) {
	var id uint
...
func (dc *DatastoreController) Create(tpl string, clusterID int) (uint, error) {
