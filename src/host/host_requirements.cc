...
do								\
  if (yychar == YYEMPTY && yylen == 1)				\
    ...
    {								\
      yyerror (&yylloc, host, result, error_msg, YY_("syntax error: cannot back up")); \
      YYERROR;							\
    }								\
while (YYID (0))
  ...
  if (yydebug)								  \
    {									  \
      ...
      yy_symbol_print (stderr,						  \
		  Type, Value, Location, host, result, error_msg); \
      YYFPRINTF (stderr, "\n");						  \
    }									  \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, Host * host, bool&  result, char ** error_msg)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, yylocationp, host, result, error_msg)
    FILE *yyoutput;
    int yytype;
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, Host * host, bool&  result, char ** error_msg)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, yylocationp, host, result, error_msg)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    YYLTYPE const * const yylocationp;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, Host * host, bool&  result, char ** error_msg)
#else
static void
yy_reduce_print (yyvsp, yylsp, yyrule, host, result, error_msg)
    YYSTYPE *yyvsp;
    YYLTYPE *yylsp;
    int yyrule;
    Host * host;
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, yylsp, Rule, host, result, error_msg); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, Host * host, bool&  result, char ** error_msg)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, yylocationp, host, result, error_msg)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    YYLTYPE *yylocationp;
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (Host * host, bool&  result, char ** error_msg);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (Host * host, bool&  result, char ** error_msg)
#else
int
yyparse (host, result, error_msg)
    Host * host;
    bool&  result;
    char ** error_msg;
#endif
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (&yylloc, host, result, error_msg, YY_("syntax error"));
#else
      {
	...
	if (0 < yysize && yysize <= yymsg_alloc)
	  {
	    ...
	    yyerror (&yylloc, host, result, error_msg, yymsg);
	  }
	else
	  {
	    yyerror (&yylloc, host, result, error_msg, YY_("syntax error"));
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct ("Error: popping",
		  yystos[yystate], yyvsp, yylsp, host, result, error_msg);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (&yylloc, host, result, error_msg, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
		  yystos[*yyssp], yyvsp, yylsp, host, result, error_msg);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
