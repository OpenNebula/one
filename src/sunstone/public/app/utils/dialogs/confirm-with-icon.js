...
define(function(require) {
  ...
  var TemplateHTML = require('hbs!./confirm-with-icon/html');
  ...
  var DIALOG_ID = require('./confirm-with-icon/dialogId');
  ...
  function _setup(dialog) {
    $(dialog).keypress(function (e) {
      if (e.which == 13 || e.keyCode == 13) {
        $('#confirm_with_icon_proceed', dialog).click();
        return false;
      } else {
        return true;
      }
  ...
  function _onShow(dialog) {
    ...
    $('#confirm_with_icon_proceed', dialog).val(actionId);
    $('#confirm_with_icon_tip', dialog).text(tip);
