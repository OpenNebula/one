...
define(function (require) {
    ...
    function _setup(context) {
        ...
        $("input[name='rep']", context).change(function () {
            ...
            switch (value) {
                case "week":
                    input_html = '<div id="days_week_value" style="display: -webkit-box;">\
                    ...
                    break;
                case "month":
                    input_html = '<input id="days_month_value" type="text" placeholder="1,31"/>';
                    break;
                case "year":
                    input_html = '<input id="days_year_value" type="text" placeholder="0,365"/>';
                    break;
            }
        ...
        $("input[name='end_type']", context).change(function () {
            ...
            switch (value) {
                case "n_rep":
                    input_html = '<input id="end_value_n_rep" type="number" placeholder="1"/>';
                    min = 1;
                    break;
                case "date":
                    input_html = '<input id="end_value_date" type="date"/>';
                    var today = new Date();
                    var dd = today.getDate();
                    var mm = today.getMonth() + 1;
                    var yyyy = today.getFullYear();
