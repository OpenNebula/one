define(function(require) {
  ...
  var TemplateVmsCreate = require('hbs!./provision-tab/vms/create');
  ...
  var provision_create_flow = '<form id="provision_create_flow" class="hidden section_content">'+
    ...
    '<div class="row">'+
      '<div class="large-8 large-centered columns">'+
        '<input type="text" id="flow_name"  class="provision-input" placeholder="'+Locale.tr("Service Name")+'" style="height: 40px !important; font-size: 16px; padding: 0.5rem  !important;"/>'+
        '<br>'+
      '</div>'+
    '</div>'+
    '<div class="row">'+
    ...
    '<div class="row">'+
      '<div class="large-7 columns large-centered">'+
        ...
        '</div>'+
        '<button href="#" class="button large success radius large-12 small-12" type="submit" style="height: 59px">'+Locale.tr("Create")+'</button>'+
      '</div>'+
    '</div>'+
    '<br>'+
    '<br>'+
  ...
  '<div class="row provision_rvms_quota">'+
    '<div class="medium-3 small-12 columns">'+
      '<select class="provision_quota_select">'+
        '<option value="edit">'+Locale.tr("Manual")+'</option>'+
        '<option value="unlimited">'+Locale.tr("Unlimited")+'</option>'+
        '<option value="default">'+Locale.tr("Default")+'</option>'+
      '</select>'+
    '</div>'+
    ...
    '<div class="medium-9 small-12 columns provision_quota_unlimited" style="display:none">'+
      '<span style="font-size: 18px; color: #999">'+
        Locale.tr("Unlimited. Group quotas will still apply")+
      '</span>'+
    '</div>'+
    '<div class="medium-9 small-12 columns provision_quota_default" style="display:none">'+
      '<span style="font-size: 18px; color: #999">'+
        Locale.tr("Use the default system quotas set by the cloud adminstrator")+
      '</span>'+
    '</div>'+
  '</div>'+
  '<div class="row">'+
  ...
  var provision_create_user = '<form id="provision_create_user" class="hidden section_content">'+
    ...
    '<div class="row">'+
      '<div class="large-8 large-centered columns">'+
        '<input type="text" id="username"  class="provision-input" placeholder="'+Locale.tr("Username")+'" style="height: 40px !important; font-size: 16px; padding: 0.5rem  !important;"/>'+
        '<br>'+
      '</div>'+
    '</div>'+
    '<div class="row">'+
      '<div class="large-8 large-centered columns">'+
        '<input type="password" id="password"  class="provision-input" placeholder="'+Locale.tr("Password")+'" style="height: 40px !important; font-size: 16px; padding: 0.5rem  !important;"/>'+
        '<br>'+
      '</div>'+
    '</div>'+
    '<div class="row">'+
      '<div class="large-8 large-centered columns">'+
        '<input type="password" id="repeat_password"  class="provision-input" placeholder="'+Locale.tr("Repeat Password")+'" style="height: 40px !important; font-size: 16px; padding: 0.5rem  !important;"/>'+
        '<br>'+
      '</div>'+
    '</div>'+
    '<div class="row">'+
    ...
    '<div class="row">'+
      '<div class="large-8 large-centered columns">'+
        '<dl class="tabs text-center" data-tab style="width: 100%">'+
          '<dd class="active" style="width: 50%;"><a href="#provision_create_user_default_quota">'+ Locale.tr("Default") +'</a></dd>'+
          '<dd style="width: 50%;"><a href="#provision_create_user_manual_quota">'+ Locale.tr("Manual") +'</a></dd>'+
        '</dl>'+
    ...
    '<div class="row">'+
      '<div class="large-7 columns large-centered">'+
        '<div data-alert class="alert-box alert-box-error radius text-center hidden">'+
        '</div>'+
        '<button href="#" class="button large radius large-12 small-12" type="submit">'+Locale.tr("Add User")+'</button>'+
      '</div>'+
    '</div>'+
    '<br>'+
  '</form>';
        ...
        '<div class="row dashboard_vm_accounting">'+
          '<div id="acct_content">'+
            '<div class="large-6 columns">'+
              ...
              '<div class="row">'+
                '<div class="large-12 columns graph_legend text-center">'+
                  '<span style="color: #777; font-size: 14px">'+Locale.tr("CPU hours")+'</span>'+
                '</div>'+
                '<br>'+
                '<div class="large-12 columns">'+
            ...
            '<div class="large-6 columns">'+
              '<div class="row">'+
                '<div class="large-12 columns graph_legend text-center">'+
                  '<span style="color: #777; font-size: 14px">'+Locale.tr("Memory GB hours")+'</span>'+
                '</div>'+
                '<div class="large-12 columns">'+
    ...
    return '<dl class="accordion accordion_list provision_list_users" data-accordion>'+
      '<dd class="active accordion-navigation">'+
        ...
        '<h2 class="subheader">'+
            ...
            '</span>'+
            '<span href"#" class="right only-active provision_users_list_refresh_button button medium radius secondary" data-tooltip title="'+ Locale.tr("Refresh")+'">'+
              '<i class="fa fa-fw fa-lg fa-refresh"/>'+
            '</span>'+
            '<span href"#" class="right only-not-active provision_refresh_info button medium radius secondary" data-tooltip title="'+ Locale.tr("Refresh")+'">'+
              '<i class="fa fa-fw fa-lg fa-refresh"/>'+
            '</span>'+
  ...
  function provision_list_templates(opts_arg){
    ...
    return '<dl class="accordion accordion_list provision_list_templates" data-accordion="dfsaf">'+
      '<dd class="'+ (opts.active ? 'active' : '') +' accordion-navigation">'+
        ...
        '<h2 class="subheader">'+
          opts.title +
          '<span href"#" class="right only-active button medium radius secondary provision_templates_list_refresh_button"  '+(!opts.refresh ? 'style="display:none" ': "") + 'data-tooltip title="'+ Locale.tr("Refresh")+'">'+
            '<i class="fa fa-fw fa-lg fa-refresh"/>'+
          '</span>'+
          '<span href"#" class="right only-active button medium radius secondary provision_templates_list_filter_button"  '+(!opts.filter ? 'style="display:none" ': "") + 'data-tooltip title="'+ Locale.tr("Filter by User")+'">'+
              ...
              '<table class="provision_templates_table">'+
                '<thead class="hidden">'+
                  '<tr>'+
                    '<th>'+Locale.tr("ID")+'</th>'+
                    '<th>'+Locale.tr("Name")+'</th>'+
                    '<th>'+Locale.tr("Saved")+'</th>'+
                    '<th>'+Locale.tr("User ID")+'</th>'+
                  '</tr>'+
                '</thead>'+
                '<tbody class="hidden">'+
                '</tbody>'+
        ...
        '<div class="row">'+
          '<div class="large-6 medium-6  columns">'+
            '<div class="row text-center">'+
              '<div class="large-12 columns">'+
                '<h3 class="subheader"><small>'+Locale.tr("CPU")+'</small></h3>'+
              '</div>'+
            '</div>'+
            '<div class="row">'+
              '<div class="large-12 columns">'+
          ...
          '<div class="large-6 medium-6 columns">'+
            '<div class="row text-center">'+
              '<div class="large-12 columns">'+
                '<h3 class="subheader"><small>'+Locale.tr("MEMORY")+'</small></h3>'+
              '</div>'+
            '</div>'+
            '<div class="row">'+
              '<div class="large-12 columns">'+
    ...
    return '<dl class="accordion accordion_list provision_list_vms" data-accordion>'+
      '<dd class="'+ (opts.active ? 'active' : '') +' accordion-navigation">'+
          ...
          '<h2 class="subheader">'+
            ...
            '</span>'+
            '<span href"#" class="right only-active button medium radius secondary provision_vms_list_refresh_button" '+(!opts.refresh ? 'style="display:none" ': "") + 'data-tooltip title="'+ Locale.tr("Refresh")+'">'+
              '<i class="fa fa-fw fa-lg fa-refresh"/> '+
            '</span>'+
            '<span href"#" class="right only-not-active button medium radius secondary provision_refresh_info" '+(!opts.refresh ? 'style="display:none" ': "") + 'data-tooltip title="'+ Locale.tr("Refresh")+'">'+
              '<i class="fa fa-fw fa-lg fa-refresh"/>'+
            '</span>' +
            '<span href"#" class="right only-active button medium radius secondary provision_vms_list_filter_button" '+(!opts.filter ? 'style="display:none" ': "") + 'data-tooltip title="'+ Locale.tr("Filter by User")+'">'+
              '<i class="fa fa-fw fa-lg fa-filter"/> '+
            '</span>'+
    ...
    return '<dl class="accordion accordion_list provision_list_flows" data-accordion>'+
      '<dd class="'+ (opts.active ? 'active' : '') +' accordion-navigation">'+
        ...
        '<h2 class="subheader">'+
          ...
          '</span>'+
          '<span href"#" class="only-active right button radius medium secondary provision_flows_list_refresh_button"  '+(!opts.refresh ? 'style="display:none" ': "") + 'data-tooltip title="'+ Locale.tr("Refresh")+'">'+
            '<i class="fa fa-fw fa-lg fa-refresh"/>'+
          '</span>'+
          '<span href"#" class="only-not-active right button medium radius secondary provision_refresh_info"  '+(!opts.refresh ? 'style="display:none" ': "") + 'data-tooltip title="'+ Locale.tr("Refresh")+'">'+
            '<i class="fa fa-fw fa-lg fa-refresh"/>'+
          '</span>'+
          '<span href"#" class="only-active right button radius medium secondary provision_flows_list_filter_button"  '+(!opts.filter ? 'style="display:none" ': "") + 'data-tooltip title="'+ Locale.tr("Filter by User")+'">'+
            '<i class="fa fa-fw fa-lg fa-filter"/> '+
          '</span>'+
  ...
  var provision_header = '<a href="#" class="provision_image_header" ><img src="'+Config.provision.logo+'" style="height:40px; vertical-align:top"></a><br><br>'+
     '<ul class="inline-list text-center" style="font-size:13px; padding-bottom: 10px; border-bottom: 1px solid #efefef;">';

  if (Config.isTabPanelEnabled("provision-tab", "users")) {
    provision_header +=
      '<li>'+
        '<a href"#" class="medium off-color" id="provision_vdc_info_button"><i class="fa fa-fw fa-2x fa-bar-chart-o"/>'+Locale.tr("Group Info")+'</a>'+
      '</li>'+
      '<li>'+
        '<a href"#" class="medium off-color provision_users_list_button" id=""><i class="fa fa-fw fa-2x fa-users"/>'+Locale.tr("Users")+'</a>'+
      '</li>'
  }

  provision_header +=  '<li>'+
        '<a href"#" class="medium off-color provision_vms_list_button" id=""><i class="fa fa-fw fa-2x fa-th"/>'+Locale.tr("VMs")+'</a>'+
      '</li>'

  if (Config.isTabPanelEnabled("provision-tab", "templates")) {
    provision_header +=
      '<li>'+
        '<a href"#" class="medium off-color provision_templates_list_button"><i class="fa fa-fw fa-2x fa-save"/>'+Locale.tr("Templates")+'</a>'+
      '</li>';
  }
  ...
  if (Config.isTabPanelEnabled("provision-tab", "flows")) {
    provision_header +=
      '<li>'+
        '<a href"#" class="medium off-color provision_flows_list_button" id=""><i class="fa fa-2x fa-fw fa-cubes"/>'+Locale.tr("Services")+'</a>'+
      '</li>';
  }

    provision_header +=
      //'<li style="border-left: 1px solid #efefef; height: 40px">'+
      //'</li>'+
      //'<li>'+
      //  '<a href"#" class="medium off-color" id="provision_user_info_button"><i class="fa fa-fw fa-2x fa-user"/>'+config['display_name']+'</a>'+
      //'</li>'+
      //'<li>'+
      ...
      //    '<i class="fa fa-home fa-2x header-icon" style="margin-bottom: 2px"/> ' + config['zone_name'] +
      //  '</a>'+
