define(function(require) {
  ...
  var DATATABLE_SEARCH_ID = "imagesSearch";
  ...
  function _initialize() {
    ...
    TabDataTable.infoListener(_dataTable, "Image.show");
  ...
  var _updateElement = function(request, element_json) {
    var id = element_json.IMAGE.ID;
    var element = _elementArray(element_json);
    TabDataTable.updateSingleElement(element, _dataTable, '#image_' + id);
  }

  //callback for actions deleting a zone element
  var _deleteElement = function(req) {
    TabDataTable.deleteElement(_dataTable, '#image_' + req.request.data);
  }
