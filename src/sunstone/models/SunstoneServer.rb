...
class SunstoneServer < CloudServer
    ...
    def get_pool(kind,gid, client=nil)
        ...
        pool = case kind
            ...
            when "vmgroup"          then VMGroupPoolJSON.new(client, user_flag)
    ...
    def create_resource(kind, template)
        resource = case kind
            ...
            when "vmgroup"          then VMGroupJSON.new(VMGroup.build_xml,@client)
    ...
    def retrieve_resource(kind, id, extended=false)
        resource = case kind
            ...
            when "vmgroup"          then VMGroupJSON.new_with_id(id, @client)
